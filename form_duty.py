...
if __name__ == "__main__":
    ...
    form_duty(patten_file="Исходный_Шаблон_Весь_период.xlsx", out_file_name="Раскладка_Питание_2025.05.23_Весь_период.xlsx")
    form_duty(patten_file="Исходный_Шаблон_Первая_неделя.xlsx", out_file_name="Раскладка_Питание_2025.05.23_Первая_неделя.xlsx")
    form_duty(patten_file="Исходный_Шаблон_Вторая_неделя.xlsx",
              out_file_name="Раскладка_Питание_2025.05.30_Вторая_неделя.xlsx")
    form_duty(patten_file="Исходный_Шаблон_Вторая_неделя_общая.xlsx",
              out_file_name="Раскладка_Питание_2025.05.30_Вторая_общая.xlsx")
    form_duty(patten_file="Исходный_Шаблон_Третья_Неделя_Общая.xlsx",
              out_file_name="Раскладка_Питание_2025.06.7_Третья_Неделя_Общая.xlsx")
